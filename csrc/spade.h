...
extern void pre_pruning(Itemset *&iset, unsigned int ptempl, Itemset *it1, Itemset *it2, char use_seq, std::ostream& out);

extern void post_pruning(Itemset *&iset, unsigned int templ, std::ostream& out);

extern Itemset *prune_decision(Itemset *it1, Itemset *it2, unsigned int ptempl, int jflg, bool use_maxgap,
                               bool use_hash, bool recursive);
